...
pub mod plusnik_repository_pg;
pub mod schedule_week_repository_pg;
...
pub use plusnik_repository_pg::PlusnikRepositoryPg;
pub use schedule_week_repository_pg::ScheduleWeekRepositoryPg;
