...
//!   from different classes (e.g., "Английский B1" — ученики из 10а, 10б, 10в).
//!
...
///
/// Examples: "Английский B1", "Информатика базовая".
...
impl StudentGroup {
    ...
    ///   which counts characters, not bytes — важно для кириллицы).
    ///
